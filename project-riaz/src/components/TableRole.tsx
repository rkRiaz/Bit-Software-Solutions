import { mdiAccountEdit, mdiEye, mdiTrashCan } from '@mdi/js'
...
import InfoModal from './Client/InfoModal'
...
const TableRole = ( {clients}: Props ) => {
  ...
  return (
    <>
{/* Click eye button and the modal will show details info*/}
      <CardBoxModal
              ...
              <td className="before:hidden lg:w-1 whitespace-nowrap">
                <BaseButtons type="justify-start lg:justify-end" noWrap>
                  ...
                  <BaseButton
                    color="warning"
                    icon={mdiAccountEdit}
                    onClick={() => router.push(`/role/edit/${client.id}`)}
                    small
                  />
                  <BaseButton
                    color="danger"
